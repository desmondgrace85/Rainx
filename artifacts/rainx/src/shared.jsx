...
export const DARK_TOKENS  = { ink:"#0F0E0B", card:"#1C1913", cardBorder:"#332C1F", gold:"#F7BC2D", goldBright:"#F7BC2D", goldGradient:"linear-gradient(135deg, #F7BC2D 0%, #E3A925 50%, #D49818 100%)", goldShine:"linear-gradient(180deg, #F7BC2D 0%, #E3A925 48%, #D49818 100%)", sage:"#7A9E86",  rust:"#B0604A", paper:"#F2EDE0", muted:"#9C947F" };
export const LIGHT_TOKENS = { ink:"#FFFFFF",  card:"#F7F9F9", cardBorder:"#EFF3F4", gold:"#F7BC2D", goldBright:"#F7BC2D", goldGradient:"linear-gradient(135deg, #F7BC2D 0%, #E3A925 50%, #D49818 100%)", goldShine:"linear-gradient(180deg, #F7BC2D 0%, #E3A925 48%, #D49818 100%)", sage:"#1A7A50",  rust:"#C0392B", paper:"#0F1419", muted:"#536471" };
