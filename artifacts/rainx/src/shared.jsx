...
export const T = {
  ...
  gold: "#FFD24D",
  goldBright: "#FFD24D",
  goldGradient: "linear-gradient(135deg, #FFF3AE 0%, #FFD24D 34%, #E2A400 70%, #FFF0A0 100%)",
  goldShine: "linear-gradient(180deg, #FFF3AE 0%, #FFD24D 45%, #E2A400 100%)",
  sage: "#7A9E86",
  rust: "#B0604A",
  paper: "#F2EDE0",
  muted: "#9C947F",
...
export const DARK_TOKENS  = { ink:"#0F0E0B", card:"#1C1913", cardBorder:"#332C1F", gold:"#FFD24D", goldBright:"#FFD24D", goldGradient:"linear-gradient(135deg, #FFF3AE 0%, #FFD24D 34%, #E2A400 70%, #FFF0A0 100%)", goldShine:"linear-gradient(180deg, #FFF3AE 0%, #FFD24D 45%, #E2A400 100%)", sage:"#7A9E86",  rust:"#B0604A", paper:"#F2EDE0", muted:"#9C947F" };
export const LIGHT_TOKENS = { ink:"#FFFFFF",  card:"#F7F9F9", cardBorder:"#EFF3F4", gold:"#FFD24D", goldBright:"#FFD24D", goldGradient:"linear-gradient(135deg, #FFF3AE 0%, #FFD24D 34%, #E2A400 70%, #FFF0A0 100%)", goldShine:"linear-gradient(180deg, #FFF3AE 0%, #FFD24D 45%, #E2A400 100%)", sage:"#1A7A50",  rust:"#C0392B", paper:"#0F1419", muted:"#536471" };
