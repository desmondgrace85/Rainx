...
function GiftsRewardsScreen({ onBack, account }) {
  ...
  const closeSettings = () => { if (settingsClosing) return; setSettingsClosing(true); window.setTimeout(() => { setSettingsClosing(false); setSettings(false); }, 360); };
