...
function ReferralRewardsScreen({ count, earnings, referralCode, onBack, onActivity }) {
  ...
  return createPortal(<div className="rx-referral-screen"
    style={{position:"fixed",inset:0,zIndex:1000,overflow:"hidden",overscrollBehavior:"none",touchAction:"pan-y",background:"transparent",color:"#17191B",isolation:"isolate",contain:"layout paint"}}
  >
