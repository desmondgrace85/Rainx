...
// ─── Crypto ───────────────────────────────────────────────────────────────
const BTC = raw(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><circle cx="24" cy="24" r="24" fill="#F7931A"/><path fill="#fff" d="M31.2 21.4c.37-2.5-1.53-3.84-4.13-4.74l.84-3.39-2.05-.51-.82 3.3-1.64-.39.83-3.32-2.05-.51-.85 3.39c-.45-.1-.89-.2-1.32-.31l.01-.01-2.83-.71-.55 2.19s1.53.35 1.5.37c.83.21.98.75.96 1.18l-.96 3.84c.06.01.13.04.22.07l-.22-.05-1.34 5.37c-.1.25-.36.62-.94.48.02.03-1.5-.38-1.5-.38l-1.02 2.35 2.67.67c.5.13.98.26 1.46.38l-.86 3.45 2.05.51.85-3.4c.56.15 1.11.29 1.64.42l-.85 3.38 2.05.51.86-3.44c3.55.67 6.22.4 7.35-2.81.91-2.59-.04-4.08-1.91-5.05 1.36-.31 2.38-1.2 2.66-3.05zm-4.76 6.66c-.65 2.59-5.03.98-6.45.62l1.15-4.62c1.42.36 5.98 1.06 5.3 4zm.65-6.72c-.59 2.37-4.23.99-5.41.69l1.05-4.19c1.18.3 4.97.85 4.36 3.5z"/></svg>`);
...
const GBP = raw(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><circle cx="24" cy="24" r="24" fill="#012169"/><rect x="17" y="13" width="3" height="22" fill="#fff"/><rect x="14" y="20" width="9" height="3" fill="#fff"/><rect x="14" y="26" width="11" height="3" fill="#fff"/><path fill="none" stroke="#fff" stroke-width="2.5" stroke-linecap="round" d="M27 22c1.5-1 3.5-1.5 5-1 2 .6 2.5 3 1 4.5-1 1-3 1.5-4.5 1.5" transform="translate(-1 0)"/><path fill="none" stroke="#C8102E" stroke-width="1" d="M17.5 13h2v22h-2z"/><path fill="none" stroke="#C8102E" stroke-width="0.8" d="M14 20.5h9M14 26.5h11"/></svg>`);
const USD = raw(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><circle cx="24" cy="24" r="24" fill="#3C3B6E"/><g fill="#fff"><circle cx="14" cy="14" r="1"/><circle cx="20" cy="11" r="1"/><circle cx="28" cy="11" r="1"/><circle cx="34" cy="14" r="1"/><circle cx="11" cy="19" r="1"/><circle cx="18" cy="16" r="1"/><circle cx="24" cy="14" r="1"/><circle cx="30" cy="16" r="1"/><circle cx="37" cy="19" r="1"/></g><rect x="10" y="24" width="28" height="2" fill="#B22234"/><rect x="10" y="28" width="28" height="2" fill="#B22234"/><rect x="10" y="32" width="28" height="2" fill="#B22234"/></svg>`);
...
const CAD = raw(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><circle cx="24" cy="24" r="24" fill="#D80621"/><path fill="#fff" d="M22 14h4v6h6v4h-6v6h-4v-6h-6v-4h6z"/></svg>`);
...
const SPX = raw(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><circle cx="24" cy="24" r="24" fill="#1a1a1a"/><text x="24" y="31" text-anchor="middle" font-size="14" font-weight="bold" fill="#FFBE0B" font-family="Arial">S&amp;P</text></svg>`);
...
const GER = raw(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><circle cx="24" cy="24" r="24" fill="#1a1a1a"/><path fill="#fff" d="M12 20h24v2H12zm0 5h24v2H12z"/><path fill="#FFBE0B" d="M20 16h8v4h-8z"/></svg>`);

// ─── Default / news fallback ──────────────────────────────────────────────
const RAINX = raw(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><circle cx="24" cy="24" r="24" fill="#0F0E0B"/><path fill="#FFBE0B" d="M24 13c-4 0-7 3-7 7 0 1 .2 2 .6 2.8L18 25c-2 1.5-2 4 0 5.5L24 35l6-4.5c2-1.5 2-4 0-5.5l.4-2.2c.4-.8.6-1.8.6-2.8 0-4-3-7-7-7z"/></svg>`);
const NEWS = raw(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><circle cx="24" cy="24" r="24" fill="#1C1913"/><rect x="13" y="15" width="22" height="18" rx="2" fill="none" stroke="#FFBE0B" stroke-width="2"/><path fill="#FFBE0B" d="M16 20h10v1.8H16zm0 4h16v1.8H16zm0 4h12v1.8H16z"/></svg>`);
