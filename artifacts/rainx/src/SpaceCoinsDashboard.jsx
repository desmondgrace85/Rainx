    ...
    <main className="sc-screen sc-dashboard-screen" style={{ background: T.ink, color: T.paper }} {...edgeBack}>
      <style>{`
        .sc-dashboard-screen { animation:sc-dashboard-enter .42s cubic-bezier(.22,.75,.2,1) both; }
         ...
         .sc-planet-reference { position:absolute; right:-7px; top:8px; width:165px; height:120px; object-fit:cover; object-position:right center; animation:sc-planet-turn 7s ease-in-out infinite; filter:drop-shadow(0 9px 11px rgba(255,195,0,.18)); }
