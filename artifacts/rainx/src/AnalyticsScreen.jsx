...
function Pills({items,active,onChange}){return <div style={{display:"flex",gap:10,overflowX:"auto",overflowY:"hidden",scrollbarWidth:"none",touchAction:"pan-x",overscrollBehaviorX:"contain",paddingBottom:2}}>{items.map(x=><button key={x} onClick={()=>onChange(x)} style={{flexShrink:0,border:0,borderRadius:24,padding:"10px 18px",background:active===x?"#000":"#E9EAEC",color:active===x?"#fff":"#73777C",fontFamily:FONT,fontWeight:700,fontSize:15}}>{x}</button>)}</div>}
