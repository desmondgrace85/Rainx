  ...
  return (
    ...
    >
      <style>{`
        ...
        .sc-coin-art { position:absolute; z-index:5; left:68px; top:88px; width:56px; height:56px; object-fit:contain; filter:drop-shadow(0 6px 9px rgba(244,211,94,.18)); animation:sc-coin-drift 4.8s ease-in-out infinite; pointer-events:none; }
        .sc-orbit-art { position:absolute; z-index:5; right:4px; top:45px; width:100px; height:160px; object-fit:contain; filter:drop-shadow(0 6px 10px rgba(244,211,94,.18)); animation:sc-orbit-drift 5.6s ease-in-out infinite; pointer-events:none; }
