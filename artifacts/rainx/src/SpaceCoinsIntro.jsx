  ...
  return (
    <main className="sc-intro-page"
      ...
      <style>{`
        ...
        .sc-intro-title{margin:0;color:#F4D35E;font-size:37px;line-height:.98;font-weight:800;letter-spacing:-2px;text-shadow:0 4px 20px rgba(244,211,94,.18)}
        .sc-intro-heading{margin:30px 0 0;font-size:23px;line-height:1.1;font-weight:700;letter-spacing:-.9px}
        .sc-intro-description{margin:17px 0 0;color:#747A80;font-size:16px;line-height:1.55;font-weight:400;letter-spacing:-.2px}

        /* Match the reference CTA width instead of stretching across the whole screen. */
        ...
        .sc-intro-cta-arrow svg{width:20px;height:20px}

        /* The artwork starts immediately below the CTA and is deliberately larger/higher,
           matching the supplied reference instead of being pushed down by a flex spacer. */
        .sc-intro-art{position:relative;flex:1 1 auto;min-height:330px;height:auto;margin:18px auto 0;width:100%;overflow:visible;pointer-events:none}
        ...
        .sc-intro-platform{position:absolute;left:50%;bottom:-6px;width:min(116%,500px);height:auto;transform:translateX(-50%);object-fit:contain;filter:drop-shadow(0 14px 14px rgba(198,145,18,.13))}
        .sc-intro-rocket{position:absolute;left:50%;bottom:190px;width:110px;height:auto;transform:translateX(-50%);object-fit:contain;filter:drop-shadow(0 14px 13px rgba(198,145,18,.12));animation:sc-intro-rocket-float 3.6s ease-in-out infinite}
        .sc-intro-orbit{position:absolute;left:50%;bottom:200px;width:min(88%,320px);height:auto;transform:translateX(-50%);object-fit:contain;opacity:.98}
        .sc-intro-coin{position:absolute;left:calc(50% - 150px);bottom:56%;width:58px;height:58px;object-fit:contain;filter:drop-shadow(0 7px 8px rgba(198,145,18,.16));animation:sc-intro-coin-float 3.2s ease-in-out infinite}
        ...
        .sc-intro-star.s1{left:calc(50% + 112px);bottom:53%;width:15px;height:15px}
        .sc-intro-star.s2{left:calc(50% + 30px);bottom:67%;width:8px;height:8px;animation-delay:-.7s}
        .sc-intro-star.s3{left:calc(50% + 74px);bottom:73%;width:7px;height:7px;animation-delay:-1.1s}
        ...
        @media(max-width:430px){
          ...
          .sc-intro-cta{width:215px;height:52px}
          .sc-intro-art{min-height:330px;margin-top:18px}
          .sc-intro-rocket{width:110px;bottom:190px}
          .sc-intro-orbit{width:88%;bottom:200px}
          .sc-intro-platform{width:116%;max-width:500px;bottom:-8px}
          .sc-intro-coin{left:calc(50% - 125px);width:52px;height:52px}
          .sc-intro-star.s1{left:calc(50% + 94px)}
        }
        ...
        @media(max-height:720px) and (max-width:599px){
          ...
          .sc-intro-cta{margin-top:22px;height:52px}
          .sc-intro-art{min-height:245px;margin-top:14px}
          .sc-intro-rocket{width:94px;bottom:142px}
          .sc-intro-orbit{width:235px;bottom:150px}
          .sc-intro-platform{width:390px}
          .sc-intro-coin{left:calc(50% - 105px);width:45px;height:45px}
        }
        ...
        <div className="sc-intro-inner">
          ...
          <section className="sc-intro-copy">
            ...
            <button type="button" className="sc-intro-cta" onClick={onExplore}>
              ...
              <span className="sc-intro-cta-arrow"><ArrowRight size={20} strokeWidth={2.1}/></span>
            </button>
          </section>
