  ...
  return (
    ...
    >
      <style>{`
        ...
        .sc-title-gold { color:transparent; background:var(--sc-gold-gradient); -webkit-background-clip:text; background-clip:text; -webkit-text-fill-color:transparent; }
        ...
        .sc-coin-art { position:absolute; z-index:5; left:68px; top:88px; width:56px; height:56px; object-fit:contain; filter:drop-shadow(0 6px 9px rgba(226,164,0,.22)); animation:sc-coin-drift 4.8s ease-in-out infinite; pointer-events:none; }
        .sc-orbit-art { position:absolute; z-index:5; right:4px; top:45px; width:100px; height:160px; object-fit:contain; filter:drop-shadow(0 6px 10px rgba(226,164,0,.22)); animation:sc-orbit-drift 5.6s ease-in-out infinite; pointer-events:none; }
